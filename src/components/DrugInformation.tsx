...
const DrugInformation: React.FC<DrugInformationProps> = ({ drugData, isLoading }) => {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="mt-4 space-y-4">
          <div>
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
              {drugData.active_ingredients.map((ingredient, index) => (
      ...
      >
        <div className="mt-4 space-y-4">
          <div>
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
              {drugData.side_effects.common.map((effect, index) => (
                <li key={index}>{effect}</li>
              ))}
            </ul>
          </div>
          
          {drugData.side_effects.rare.length > 0 && (
            <div>
      ...
      {/* Drug Interactions */}
      {drugData.drug_interactions.length > 0 && (
        <ExpandableSection
          id="interactions"
      ...
      >
        <div className="mt-4 space-y-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {drugData.source_links.map((link, index) => (
                <li key={index}>
                  <a
                    href={link}
                    target="_blank"
